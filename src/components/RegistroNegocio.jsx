	...
	return (
		<div className="grid-container">
			<div className="derecha">
				<button className="fas fa-arrow-left botones-guia" onClick={() => history.goBack()}></button>
				...
				<div className="registronegocio-container">
					...
					<input type="text" id="negocio" onChange={(ev) => setNegocio(ev.target.value)}></input>
					...
					<input type="text" id="email-negocio" onChange={(ev) => setEmailNegocio(ev.target.value)} />
